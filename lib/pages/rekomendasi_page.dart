...
class RekomendasiPage extends StatefulWidget {
  ...
  const RekomendasiPage({super.key, required this.mealType, this.detectedIds});
  ...
  Widget _buildMenuCard(Map<String, dynamic> option) {
    ...
    return InkWell(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (_) => FoodDetailPage(menuId: menuId)),
        );
      },
              ...
              ClipRRect(
                ...
                child: CachedNetworkImage(
                  ...
                  placeholder: (context, url) =>
                      const ShimmerImage(width: double.infinity, height: 180),
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      _buildNutrientInfo(
                        "Protein",
                        "${nutrition['protein_g'].toStringAsFixed(1)}g",
                      ),
                      _buildNutrientInfo(
                        "Karbo",
                        "${nutrition['carbs_g'].toStringAsFixed(1)}g",
                      ),
                      _buildNutrientInfo(
                        "Lemak",
                        "${nutrition['fat_g'].toStringAsFixed(1)}g",
                      ),
                    ],
                  ),
                ],
              ...
              onTap: () async {
                ...
                if (mounted && success) {
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text(
                        '${option['menu_name']} ditambahkan ke rencana makan',
                      ),
