...
class _DashboardPageState extends State<DashboardPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final profileUpdated = context.select<UserPreferenceProvider, bool>(
      (p) => p.profileUpdated,
    );
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child:
            ...
            >(
              selector: (_, p) => (
                isLoading: p.isDashboardLoading,
                status: p.dashboardStatus,
                summary: p.dashboardSummary,
              ),
              builder: (context, data, _) {
                if (data.status == PreferenceStatus.initial ||
                    (data.isLoading && data.summary == null)) {
                ...
                if (data.status == PreferenceStatus.error &&
                  ...
                  return OfflinePlaceholder(
                    message:
                        context.read<UserPreferenceProvider>().dashboardError ??
                                ...
                                children: [
                                  ...
                                  >(
                                    selector: (_, auth, pref) => (
                                      ...
                                      dashboardName:
                                          pref.dashboardSummary?.user.name,
                                    ),
                                    builder: (context, data, _) {
                                      return Column(
                                        crossAxisAlignment:
  ...
  void _showFoodDetail(
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (_) => FoodDetailPage(menuId: rec.id)),
    );
  }
